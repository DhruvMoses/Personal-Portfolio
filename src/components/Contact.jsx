...
export default function Contact(props) {
    const socialLinks = [
        {
          href: 'https://github.com/DhruvMoses',
        ...
        {
          href: 'https://www.linkedin.com/in/dhruvmoses/',
          icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
          href: 'https://www.instagram.com/dhruvmoses21',
             ...
             mt-20 px-4 mx-auto lg:px-8 xl:max-w-6xl mb-20'>
                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[40ch]">
                        Click on the links below or Fill out the form to Hire me today so we can collaborate and start making 
                        amazing projects!
                    </p>
                ...
                <form 
                action="https://getform.io/f/adrnzzea"
                method='POST'
